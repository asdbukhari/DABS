...
function BookAppointment() {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      await axios
        .get(`https://dabs-af423-default-rtdb.firebaseio.com/appointment.json`)
        .then(res => {
          const data = res.data;
  ...
  const handleSubmit = async e => {
    ...
    await axios
      .post(`https://dabs-af423-default-rtdb.firebaseio.com/appointment.json`, data)
      .then(res => {
        setgetData(true);
        ...
        <div className="card w-75">
          ...
          <div className="card-body">
            <form onSubmit={e => handleSubmit(e)}>
              <div className={NameHasError ? "invalid form-group" : "form-group"}>
              ...
              <div className={docEmailHasError ? "invalid form-group my-3" : "form-group my-3"}>
                ...
                <input
                  ...
                  readOnly
                />
                {docEmailHasError && <p className="text-danger">Please enter your doc email </p>}
              </div>
              <div className={docIdHasError ? "invalid form-group" : "form-group"}>
                ...
                <input
                  ...
                  readOnly
                />
                {docIdHasError && <p className="error-text"> Please enter your email</p>}
              </div>
              <div className={diseaseHasError ? "invalid form-group mt-3" : "form-group mt-3"}>
                <label>Disease:</label>
                <input
                  type="text"
                  className="form-control"
                ...
                />
                {diseaseHasError && <p className="text-danger">Please enter your disease </p>}
              </div>
              <div className={emailHasError ? "invalid form-group mt-3" : "form-group mt-3"}>
                ...
                />
                {emailHasError && <p className="text-danger"> Please enter your email</p>}
              </div>
